...
if keyword == "create":
    ...
    if (
        ...
        and param.resume_iterations is False
...
def join_output_files():
    try:
        ...
        if param.sampling == "iterative" and not os.path.isfile(
            CONNECT_PATH + f"/data/{param.jobname}/number_{i}/model_params.txt"
        ):
        ...
        if not os.path.isfile(
            CONNECT_PATH + f"/data/{param.jobname}/N-{param.N}/model_params.txt"
        ):
            from source.join_output import CreateSingleDataFile
