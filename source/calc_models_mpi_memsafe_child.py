...
def main_child():
    ...
    while True:
        ...
        try:
            ...
            command = mpi_irecv(
                comm=child_parent, source=0, tag=99, sleep=0.1, timeout=120
            )
        ...
        while True:
            ...
            try:
                signal.alarm(40)
                # 3) Wait for a command from the parent
                try:
                ...
                signal.alarm(param.max_time_for_theory)
        ...
        try:
            result["success"] = False
            result["success_cosmo"] = False
            result["success_lkl"] = False
        except Exception as e:
            print(
                f"{prefix} WARNING: Unexpected failure while resetting success flags: {repr(e)}.",
                file=sys.stderr,
                flush=True,
            )
